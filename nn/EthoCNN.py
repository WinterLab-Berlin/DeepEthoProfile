...
class EthoCNN(nn.Module):
    ...
    def __init__(self, noClasses):
        ...
        self.c11 = nn.Conv2d(11, 64, (15, 3), padding=(7,1), stride=2)
        self.c12 = nn.Conv2d(11, 64, (3, 15), padding=(1,7), stride=2)
        self.c13 = nn.Conv2d(11, 64, (7, 5), padding=(3,2), stride=2)
        self.c14 = nn.Conv2d(11, 64, (5, 7), padding=(2,3), stride=2)
